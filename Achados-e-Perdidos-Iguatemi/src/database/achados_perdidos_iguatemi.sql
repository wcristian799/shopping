...
(1, 'Administrador Sistema', 'admin@iguatemi.com.br', '1sFOdzhNtrR/rm1KvPB8NQ==:YzlMbYQHIwa9v1AID7DVRbQzcjEg4JdoeCXjOHD/5bU=', 1, 1, '2026-02-06 00:36:17'),
...
ALTER TABLE `itens_perdidos`
  ...
  ADD KEY `idx_itens_prazo_status` (`situacao_id`,`data_registro`,`tipo_id`),
